...
from utils.probe.pose2d_image_probe import Pose2DImageProbe
...
class Pose2DImagePipeline(BaseImagePipeline):
    SINK_PATHS = (
        "latency",
        "nvurisrcbin",
        "nvstreammux",
    ...
    def build(self):
        ...
        self.pipeline.attach(
            ...
            Probe(
                "pose2d",
                Pose2DImageProbe(drawer=self.drawer, logger=logger, messager=self.messager),
            ),
        )
