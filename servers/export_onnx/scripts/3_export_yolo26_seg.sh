...
ENDPOINT="${API_URL}/${PROJECT_NAME}/export_onnx/export_yolo26_seg"

usage() {
  cat <<EOF
usage: $0 --input path/to/model.pt [--batch-size N] [--dynamic] [--conf F]

Export YOLO26 seg .pt to ONNX under models/onnx/{name}/ via ExportOnnx API.
