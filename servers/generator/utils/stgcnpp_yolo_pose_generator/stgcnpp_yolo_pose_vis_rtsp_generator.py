...
STGCNPP_YOLO_POSE_VIS_RTSP_TOPOLOGY_DOC = """
    Topology::

        nvurisrcbin{N} → nvstreammux → pgie → nvbboxsnapshot → nvtracker → nvdspreprocess
...
class StgcnppYoloPoseVisRTSPGenerator(StgcnppYoloPoseMixin, BaseRTSPVisGenerator):
    GENERATOR = "StgcnppYoloPoseVisRTSPGenerator"
