from ..base_generator.base_sahi_pose_rtsp_vis import BaseSahiPoseVisRTSPGenerator
from ..subelement_generator.nvtracker import TRACKER_LL_LIB
from .stgcnpp_yolo_pose_mixin import StgcnppYoloPoseMixin

STGCNPP_YOLO_POSE_SAHI_VIS_RTSP_TOPOLOGY_DOC = """
    Topology::
...
class StgcnppYoloPoseSahiVisRTSPGenerator(StgcnppYoloPoseMixin, BaseSahiPoseVisRTSPGenerator):
    GENERATOR = "StgcnppYoloPoseSahiVisRTSPGenerator"
