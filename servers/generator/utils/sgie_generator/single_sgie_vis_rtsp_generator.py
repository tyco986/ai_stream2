...
class SingleSgieVisRTSPGenerator(SingleSgieMixin, BaseRTSPVisGenerator):
    GENERATOR = "SingleSgieVisRTSPGenerator"
    SINK_PATH_TEMPLATES = {
    ...
    f"""Generate single-SGIE RTSP pipeline with OSD preview.
