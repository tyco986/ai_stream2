...
YoloDet = {
    "property": {
        ...
        "custom-lib-path": "/opt/ai_stream2/servers/deepstream/libs/libnvdsinfer_custom_impl_Yolo.so",
...
YoloSeg = {
    "property": {
        ...
        "net-scale-factor": 0.00392156862745098,
        "infer-dims": "3;640;640",
        "custom-lib-path": "/opt/ai_stream2/servers/deepstream/libs/libnvdsinfer_custom_impl_Yolo_seg.so",
