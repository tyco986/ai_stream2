...
STGCNPP_RTMPOSE_SAHI_VIDEO_TOPOLOGY_DOC = """
    Topology::

        nvurisrcbin → nvstreammux → nvsahipreprocess → pgie → queue_sahi → nvsahipostprocess
            → nvbboxsnapshot → nvtracker → nvdspreprocess_rtmpose → sgie0 → nvdspreprocess → sgie1 → nvdsanalytics
...
class StgcnppRtmposeSahiVideoGenerator(StgcnppRtmposeMixin, BaseSahiVideoGenerator):
    GENERATOR = "StgcnppRtmposeSahiVideoGenerator"
