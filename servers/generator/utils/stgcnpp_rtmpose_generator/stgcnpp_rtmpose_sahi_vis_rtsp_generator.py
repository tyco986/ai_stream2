...
STGCNPP_RTMPOSE_SAHI_VIS_RTSP_TOPOLOGY_DOC = """
    Topology::
...
class StgcnppRtmposeSahiVisRTSPGenerator(StgcnppRtmposeMixin, BaseSahiVisRTSPGenerator):
    GENERATOR = "StgcnppRtmposeSahiVisRTSPGenerator"
