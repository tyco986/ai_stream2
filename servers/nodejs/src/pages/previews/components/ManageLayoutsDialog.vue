<template>
  ...
  >
    ...
    <UiTable :data="rows" row-key="id" @selection-change="onSelectionChange">
      ...
      <UiTableColumn prop="name" :label="t('preview.name')" min-width="140" />
      <UiTableColumn prop="stream_count" :label="t('preview.streams')" width="90" />
      <UiTableColumn :label="t('preview.grid')" width="80">
